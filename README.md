...
graph TD    A[Input Layer<br>Dynamic Size] --> B[Dense + ReLU + Dropout 0.2]    B --> C[Dense + ReLU + Dropout 0.2<br>Compressed Size]    C --> D[Dense 1 + Sigmoid]    D --> E((Output: 0.0 to 1.0))        style A fill:#f9f9f9,stroke:#333,stroke-width:2px    style E fill:#d4edda,stroke:#28a745,stroke-width:2px
